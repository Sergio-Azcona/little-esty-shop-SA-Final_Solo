...
RSpec.describe InvoiceItem do 
  ...
  #   @two_get_twenty = BulkDiscount.create!(discount_name:"2 get 20!", percentage: 20, quantity_threshold: 2, merchant: @klein_rempel) 
  #   @threes = BulkDiscount.create!(discount_name:"Threes", percentage: 3, quantity_threshold: 3, merchant: @klein_rempel) 
  #   @four_fives = BulkDiscount.create!(discount_name:"4Five", percentage: 5, quantity_threshold: 4, merchant: @klein_rempel) 
  #   @perfect_10 = BulkDiscount.create!(discount_name:"Perfect 10s", percentage: 10, quantity_threshold: 10, merchant: @dk)
  #   @lucky6 = BulkDiscount.create!(discount_name:"Lucky 6", percentage: 6, quantity_threshold: 6, merchant: @dk)
  # end

  # describe "Invoice Total Revenue and Discounted Revenue" do
  #   it 'returns the invoice total revenue' do
  #   # require 'pry';binding.pry
  #   # expect(invoice2.total_revenue).to eq 160
  #   end
  # end

  # describe 'calculates discounted amount' do

    # it 'returns the best discount on an invoice by item' do
    #   expect(@invoice_item2.discounted_revenue).to eq(236)
    #   item.merchant.bulk_discounts.where()
    # end

    # it "total discounted revenue for my merchant from this invoice which includes bulk discounts in the calculation" do
