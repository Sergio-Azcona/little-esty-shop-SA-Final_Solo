...
RSpec.describe Invoice do 
  ...
  describe "model methods" do
    before(:each) do
      ...
      @invoice2_sean_21 = Invoice.create!(status: 1, customer: @sean, created_at: "2021-11-01 11:00:00 UTC") 
      @invoice3_emily_22 = Invoice.create!(status: 1, customer: @emily, created_at: "2022-11-01 11:00:00 UTC") 
    ...
    xit 'calculates the discouynt applied' do
      expect(@invoice1.discount_calculation).to eq(55)
    end
  end
  ...
  # @funnypowder = Item.create!(name: "Funny Brick of Powder", description: "White Powder with Gasoline Smell", unit_price: 100) 
  # @trex = Item.create!(name: "T-Rex", description: "Skull of a Dinosaur", unit_price: 100) 
  # @ufo = Item.create!(name: "UFO Board", description: "Out of this world MotherBoard", unit_price: 50) 
  ...
  # @invoice1_trex = InvoiceItem.create!(quantity: 10, unit_price: 100, status: 1, item: @trex, invoice: @invoice1_sergio_20) 
  # @invoice2_ufo = InvoiceItem.create!(quantity: 4, unit_price: 50, status: 2, item: @ufo, invoice: @invoice2_sean_21) 
  # @invoice2_trex = InvoiceItem.create!(quantity: 10, unit_price: 100, status: 1, item: @trex, invoice: @invoice2_sean_21) 
